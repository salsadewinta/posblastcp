...
const loadPelanggan = async (req, res) =>{
  ...
  try{
      ...
      res.render('em/pelanggan/get', {user: req.session.user, infos:infos, infos: reversedPosts });
  }
...
const loadUpdatePelanggan = async (req, res) =>{
  ...
  try{
      ...
      res.render('em/pelanggan/update', {user: req.session.user, infos:infos });
  }
...
const loadCreate = async (req, res) => {
  try {
    ...
    res.render('em/pelanggan/create', {
...
const loadUjipetik = async (req, res) =>{
  ...
  try{
      var infos = await Info.find(id)
      const reversedPosts = infos.reverse();
      res.render('em/pelanggan/ujipetik', {user: req.session.user, infos:infos, infos: reversedPosts });
  }
...
const updateUjipetik = async(req, res) => {
  ...
  Info.findByIdAndUpdate(id, {
    ...
    .then(() => {
      res.redirect('/em/pelanggan/ujipetik');
    })
    .catch(err => console.log(err));
}
...
const loadUpdateUjipetik = async (req, res) =>{
  ...
  try{
      const infos = await Info.findById({ _id: id });
      res.render('em/pelanggan/update_ujipetik', {user: req.session.user, infos:infos });
  }
